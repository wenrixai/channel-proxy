...
export WP_CHANNELS_TRAVELFUSION_PROXY_PASS=${WP_SERVER_PROXY_PASS:-"https://${WP_CHANNELS_TRAVELFUSION_HOST}"}
...
export WP_CHANNELS_BA_PROXY_PASS=${WP_SERVER_PROXY_PASS:-"https://${WP_CHANNELS_BA_HOST}"}

# Farelogix AA
export WP_CHANNELS_FARELOGIX_AA_HOST=${WP_CHANNELS_FARELOGIX_AA_HOST:-aa.farelogix.com}
export WP_CHANNELS_FARELOGIX_AA_PROXY_PASS=${WP_SERVER_PROXY_PASS:-"https://${WP_CHANNELS_FARELOGIX_AA_HOST}"}
...
export WP_CHANNELS_FARELOGIX_LH_PROXY_PASS=${WP_SERVER_PROXY_PASS:-"https://${WP_CHANNELS_FARELOGIX_LH_HOST}"}
